...
class PostController extends Controller
{
    ...
    public function update(PostStoreRequest $request, string $id)
    {
        ...
        $post->update();
        return redirect()->route('posty.index')->with('message', 'Uaktualniono poprawnie posta')->with('class', 'success');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post = Posty::findOrFail($id);
        $post->delete();
        return redirect()->route('posty.index')->with('message', 'usunięto poprawnie posta')->with('class', 'danger');
    }
}
